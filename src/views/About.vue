<template>
  <div>
    <Form ref="form" :rules="formValidate" :label-width="120" :model="form">
      ...
      <Row>
        <i-col span="12" class="form-i-col">
      ...
      <Row>
        ...
        <i-col span="12" class="form-i-col">
          <FormItem label="文件上传一" prop="venIdno">
            <formUpload action="/api/upload.php" v-model="form.imageUrl1" />
          </FormItem>
        </i-col>
      </Row>
      <Row>
        <i-col span="12" class="form-i-col">
          <FormItem label="文件上传二" prop="venIdno">
            <formUpload action="/api/upload.php" v-model="form.imageUrl2" />
          </FormItem>
        </i-col>
        <i-col span="12" class="form-i-col">
          <FormItem label="文件上传f三" prop="venIdno">
            <formUpload action="/api/upload.php" v-model="form.imageUrl3" />
          </FormItem>
        </i-col>
      </Row>
